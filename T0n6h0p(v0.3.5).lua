...
AddButton(Tab1o, {
    Name = "Tigerv0.2 | ( Nokey )",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/RoyEnigmatic/MainI/refs/heads/main/Tigerv0.2.lua"))()
    end
})
