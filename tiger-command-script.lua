if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("HoangTiger cmds hub is already running!", 0)
    return
end
...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "HoangTiger cmds hub is waiting for the game to load"
    game.Loaded:Wait()
    notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "HoangTiger cmds FE v" .. currentVersion
...
SettingsButton.Image = "rbxassetid://128504363561748"
...
ReferenceButton.Image = "rbxassetid://128504363561748"
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Unstable Device", "On mobile, HoangTiger cmds may have issues or features that are not functioning correctly.") end
end)
