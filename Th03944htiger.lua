loadstring(game:HttpGet("https://raw.githubusercontent.com/Hoang223-design/Guitg/refs/heads/main/obf_ETuTutz1X49yQrCEtQoj7DPn2A619p82LY9tA8peZ3p9Ni1tEk7NeLUvPtj_Gui.lua"))()
  
local Window = MakeWindow({
    Hub = {
        Title = "Hoang Tiger | Tổng Hợp Script v0.6",
    ...
    Key = {
        ...
        KeyLink = "Phim sex không che FULL HDR",
        Keys = {"quynh"},
        Notifi = {
            Notifications = true,
...
local Tab3o = MakeTab({Name = "🍎 Trái cây script"})
local Tab4o = MakeTab({Name = "⚔️ PvP script"})
